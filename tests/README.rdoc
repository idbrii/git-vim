...
== Compatibility
These unit tests require Cygwin to run in Windows.  It's not for any
fundamental reason, just that they use some shell commands to create the
directory under git control.  If someone wanted to put in the effort, the
tests could be made cross platform relatively easily.
